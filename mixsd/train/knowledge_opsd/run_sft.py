#!/usr/bin/env python3
"""SFT entry point for the knowledge_opsd dataset using nemo-rl's built-in SFT.
...
This is the apples-to-apples counterpart to
  scripts/sbatch_offpsd_knowledge_nll_gt_d5_e10_qwen3_8b_n1_t0_20260425.sh
which does NLL on a base-model+GT-context rollout. Same nemo-rl framework,
same model, same optimizer/scheduler/batch/seq length — only the supervision
source changes (dataset GT vs base-model greedy rollout).
