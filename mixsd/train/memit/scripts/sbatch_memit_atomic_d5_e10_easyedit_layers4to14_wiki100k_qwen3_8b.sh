#!/bin/bash
#SBATCH --job-name=memit-know-atomic-d5e10-easyedit-layers4to14-wiki100k-qwen3-8b
...
DATA="${ROOT_DIR}/mixsd_data/data/knowledge_d5_e10/atomic_sft/train_messages.jsonl"
HPARAMS="${BASE_DIR}/configs/qwen3_8b_easyedit_layers4to14_wiki100k.json"
OUTPUT_DIR="${ROOT_DIR}/mixsd_data/checkpoints/knowledge/memit_atomic_d5_e10_easyedit_layers4to14_wiki100k_qwen3_8b"
